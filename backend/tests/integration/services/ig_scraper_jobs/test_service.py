...
class FakeJobControlRepository:
    def __init__(self) -> None:
        ...
        self.claim_terminal_result = TerminalizationDecision(
            ...
            attempts=1,
            worker_id="worker-1",
            completed_at=datetime(2026, 3, 21, 12, 1, tzinfo=UTC),
...
def test_get_job_merges_redis_state_over_persisted_projection() -> None:
    ...
    jobs_collection.docs["job-1"] = {
        ...
        "expiresAt": datetime(2026, 3, 22, 12, 0, tzinfo=UTC),
        "summary": None,
        "references": None,
        "error": None,
    }
    job_control_repository.read_state_result = JobTransientState(
        ...
        attempts=2,
        worker_id="worker-1",
        heartbeat_at=datetime(2026, 3, 21, 12, 5, tzinfo=UTC),
        leased_until=datetime(2026, 3, 21, 12, 20, tzinfo=UTC),
    ...
    response = _run(
        service.complete_job(
            ...
            payload=InstagramScrapeJobTerminalizationRequest(
                ...
                attempt=1,
                worker_id="worker-1",
                completed_at=datetime(2026, 3, 21, 12, 2, tzinfo=UTC),
                summary=_summary(),
                error=None,
            ),
        )
