...
export const AccessProfileUpdateSchema = {
    properties: {
        access_profile: {
            type: 'string',
            enum: ['standard', 'ambassador'],
            title: 'Access Profile'
        }
    },
    type: 'object',
    required: ['access_profile'],
    title: 'AccessProfileUpdate'
} as const;
...
export const AdminUserPublicSchema = {
    properties: {
        email: {
            type: 'string',
            maxLength: 255,
        ...
        plan_status: {
            type: 'string',
            enum: ['trial', 'base', 'ambassador', 'none'],
            title: 'Plan Status',
            default: 'none'
        }
    },
...
export const AdminUsersPublicSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/AdminUserPublic'
            },
            type: 'array',
            title: 'Data'
        },
    ...
    type: 'object',
    required: ['data', 'count'],
    title: 'AdminUsersPublic'
} as const;

export const BillingFeatureUsagePublicSchema = {
    properties: {
        code: {
            type: 'string',
            title: 'Code'
    ...
    type: 'object',
    required: ['code', 'name', 'limit', 'used', 'reserved', 'remaining'],
    title: 'BillingFeatureUsagePublic'
} as const;

export const BillingNoticeCollectionPublicSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/BillingNoticePublic'
            },
            type: 'array',
            title: 'Data'
        }
    ...
    type: 'object',
    required: ['data'],
    title: 'BillingNoticeCollectionPublic'
} as const;

export const BillingNoticePublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
        ...
        notice_type: {
            type: 'string',
            enum: ['invoice_upcoming', 'trial_will_end', 'subscription_paused', 'access_revoked'],
            title: 'Notice Type'
        },
        status: {
            type: 'string',
    ...
    type: 'object',
    required: ['id', 'notice_type', 'status', 'title', 'message', 'created_at'],
    title: 'BillingNoticePublic'
} as const;

export const BillingSessionPublicSchema = {
    properties: {
        url: {
            type: 'string',
            title: 'Url'
...
export const BillingSummaryPublicSchema = {
    properties: {
        ...
        access_revoked_reason: {
            ...
            title: 'Access Revoked Reason'
        },
        pending_ambassador_activation: {
            type: 'boolean',
            title: 'Pending Ambassador Activation',
            default: false
        },
        cancel_at: {
            anyOf: [
        ...
        features: {
            items: {
                '$ref': '#/components/schemas/BillingFeatureUsagePublic'
            },
            type: 'array',
            title: 'Features'
        },
    ...
    type: 'object',
    required: ['access_profile', 'billing_eligible', 'trial_eligible', 'plan_status', 'features'],
    title: 'BillingSummaryPublic'
} as const;

export const BillingWebhookReceiptSchema = {
    properties: {
        received: {
            type: 'boolean',
            title: 'Received',
...
export const LegalAcceptancesSchema = {
    properties: {
        privacy_notice: {
            type: 'boolean',
            const: true,
    ...
    type: 'object',
    required: ['privacy_notice', 'terms_conditions'],
    title: 'LegalAcceptances'
} as const;

export const LegalDocumentPublicSchema = {
    properties: {
        type: {
            type: 'string',
            enum: ['privacy_notice', 'terms_conditions'],
            title: 'Type'
        },
        title: {
            type: 'string',
    ...
    type: 'object',
    required: ['type', 'title', 'url', 'version'],
    title: 'LegalDocumentPublic'
} as const;
...
export const PublicLegalDocumentsSchema = {
    properties: {
        simplified_notice: {
            type: 'string',
            title: 'Simplified Notice'
        },
        documents: {
            items: {
                '$ref': '#/components/schemas/LegalDocumentPublic'
            },
            type: 'array',
            title: 'Documents'
        }
    ...
    type: 'object',
    required: ['simplified_notice', 'documents'],
    title: 'PublicLegalDocuments'
} as const;
