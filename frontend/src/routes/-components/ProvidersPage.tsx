...
const PROVIDERS = [
  ...
  {
    provider: "Apify",
    service: "Extracción de perfiles públicos de Instagram",
    content:
      "Usernames solicitados por el usuario y datos públicos devueltos por Instagram a través del actor configurado, como metadatos de perfil, publicaciones, reels, métricas públicas y perfiles relacionados.",
    purpose:
      "Consultar, normalizar y actualizar información pública de perfiles de Instagram para búsquedas de creators, reportes y análisis dentro de Kiizama.",
  },
  {
    provider: "Resend",
