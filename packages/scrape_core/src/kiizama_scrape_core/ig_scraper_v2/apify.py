    ...
    def __init__(
        ...
        *,
        ...
        self.logger = logging.getLogger(
            "kiizama_scrape_core.ig_scraper_v2.ApifyInstagramProfileScraper"
        )
...
class ApifyInstagramScraperBackend:
    """Adapt ApifyInstagramProfileScraper to the InstagramScraperBackend port."""
