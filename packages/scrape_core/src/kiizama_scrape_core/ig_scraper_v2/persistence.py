...
class SqlInstagramCredentialsStoreV2(InstagramCredentialsStore):
    def __init__(
        self,
...
class SqlInstagramJobProjectionRepositoryV2:
...
class SqlInstagramScrapePersistenceV2(InstagramScrapePersistence):
    def __init__(self, *, session: Session) -> None:
        self._session = session
