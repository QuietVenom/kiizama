...
Traefik will use this to transmit traffic at `api.localhost.tiangolo.com` to the backend, and traffic at `app.localhost.tiangolo.com` to the frontend.
...
Frontend: http://app.localhost.tiangolo.com
